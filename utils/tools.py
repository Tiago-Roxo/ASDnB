...
def init_args(args):
    ...
    args.visualPathAVABody = os.path.join(args.dataPathAVA, 'clips_videos_body')
    args.trainTrialAVA    = os.path.join(args.trialPathAVA, 'train_loader.csv')

    if args.evalDataType == 'val':
        args.evalTrialAVA = os.path.join(args.trialPathAVA, args.valLoaderFilename)
        args.evalOrig     = os.path.join(args.trialPathAVA, args.valOrigFilename)  
