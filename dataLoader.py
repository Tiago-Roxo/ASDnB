...
class train_loader(object):
    ...
    def __getitem__(self, index):
        ...
        for line in batchList:
            ...
            visualFeaturesBody.append(load_visual(data, self.visualPathBody,numFrames, visualAug = True))
...
class val_loader(object):
    ...
    def __getitem__(self, index):
        ...
        visualFeaturesBody = [load_visual(data, self.visualPathBody,numFrames, visualAug = False)]
