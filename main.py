...
def main():
    ...
    parser.add_argument('--valLoaderFilename',     type=str, default="val_loader.csv")
    parser.add_argument('--valOrigFilename',     type=str, default="val_orig.csv")
    # Data selection
    ...
    loader = train_loader(trialFileName = args.trainTrialAVA, \
                          ...
                          visualPathBody     = os.path.join(args.visualPathAVABody, 'train'), \
                          **vars(args))
